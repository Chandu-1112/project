    ...
    <section class="main">
        ...
        <div class="main--content">
            ...
            <form class="lecture-options" id="selectForm">
                ...
                <select required name="unit" id="unitSelect" onChange="updateTable()" style="display:none">
                    <option value="A-section" selected>Select Unit</option>
                    <?php
                ...
                <select required name="venue" id="venueSelect" onChange="updateTable()" style="display:none">
                    <option value="b34" selected>Select Venue</option>
                    <?php
